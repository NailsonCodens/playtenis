...
import { ListMemberRegistrationController } from "@modules/members/useCases/listMemberByRegistration/ListMemberByRegistrationController";
...
const listMemberByRegistrationController =
  new ListMemberRegistrationController();
